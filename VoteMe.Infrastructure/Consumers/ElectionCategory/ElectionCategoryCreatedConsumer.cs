...
{
    public class ElectionCategoryCreatedConsumer : BaseConsumer
    {
        private readonly IServiceScopeFactory _scopeFactory;
        protected override string QueueName => "election-category-created";

        public ElectionCategoryCreatedConsumer(
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += async (sender, args) =>
            {
                ...
                var eventData = JsonSerializer.Deserialize<ElectionCategoryCreatedEvent>(json);
