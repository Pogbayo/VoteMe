...
{
    public class MemberJoinedConsumer : BaseConsumer
    {
        private readonly IServiceScopeFactory _scopeFactory;
        protected override string QueueName => "member-joined";

        public MemberJoinedConsumer(
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += async (sender, args) =>
            {
                ...
                var eventData = JsonSerializer.Deserialize<MemberJoinedOrganizationEvent>(json);
