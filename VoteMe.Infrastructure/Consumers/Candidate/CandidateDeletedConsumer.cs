...
{
    public class CandidateDeletedConsumer : BaseConsumer
    {
        private readonly IServiceScopeFactory _scopeFactory;
        protected override string QueueName => "candidate-deleted";

        public CandidateDeletedConsumer(
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += async (sender, args) =>
            {
                ...
                var eventData = JsonSerializer.Deserialize<CandidateDeletedEvent>(json);
                ...
                await notificationService.SendCandidateDeletedEmailAsync(
